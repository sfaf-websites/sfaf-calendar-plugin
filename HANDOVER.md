...
**Last updated:** 2026-08-19, at 3.45.0.

---

## Where things stand

The plugin is at **3.45.0**, built as `sfaf-calendar-3.45.0.zip` in the project
...
screen: if it does not say 3.45.0, the deployment is stale or partial, and that
