        ...
        <div class="uc-meta-box">
            <div class="uc-meta-row">
                ...
                <div class="uc-meta-field">
                    ...
                    <?php echo sfaf_time_field( 'uc_start_time', $start_time, array( 'label' => 'Start time', 'id' => 'uc_start_time' ) ); ?>
                </div>
                <div class="uc-meta-field">
                    <label for="uc_end_time">End Time</label>
                    <?php echo sfaf_time_field( 'uc_end_time', $end_time, array( 'label' => 'End time', 'id' => 'uc_end_time' ) ); ?>
                </div>
            </div>
            <div class="uc-meta-row">
